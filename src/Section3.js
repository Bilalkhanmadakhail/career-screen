...
function Section3(props){
    return(
        ...
        <div className="bg-[#F3F4F7] items-center flex flex-col justify-center text-center  pb-[192px] pt-24">
            ...
            <p className="mt-3  text-2xl sm:text-[36px] leading-[45px]  text-[#22252B] font-poppins" > {props.p}</p>
            <div>
                ...
                <div className="mt-12  md:flex-row sm:flex sm:flex-col sm:justify-center sm:items-center   md:flex">
                    ...
                    <div className="sm:w-[144px] sm:h-[144px] w-[120px] h-[120px]  rounded-3xl sm:ml-0 ml-4 px-3 bg-white flex flex-col items-center justify-center text-center shadow-3xl">
                        <img className="mt-5 sm:mt-0" src={box1}/>
                        <p className=" text-[#22252B] text-[16px] sm:mt-[18px] font-poppins">{props.p1}</p>
                    </div>
                    <div className="sm:w-[144px] sm:h-[144px]  w-[120px] h-[120px]  rounded-3xl ml-3 sm:ml-12 px-3  bg-white flex flex-col items-center justify-center text-center shadow-3xl">
                        <img src={box2}/>
                    ...
                    <div className="sm:w-[144px] sm:h-[144px] w-[120px] h-[120px]  rounded-3xl sm:ml-0 ml-4 px-3 md:ml-12 bg-white flex flex-col items-center justify-center text-center shadow-3xl">
                        <img src={box3}/>
                        <p className=" text-[#22252B] text-[16px] mt-[18px] font-poppins">{props.p3}</p>
                    </div>
                    <div className="sm:w-[144px] sm:h-[144px] w-[120px] h-[120px]   rounded-3xl px-3 ml-3 sm:ml-12 bg-white flex flex-col items-center justify-center text-center shadow-3xl">
                        <img src={box4}/>
...
<div className="md:flex md:flex-row flex md:mt-0 mt-5 flex-row">
                    <div className="sm:w-[144px] sm:h-[144px] w-[120px] h-[120px]  rounded-3xl px-3 md:ml-12 bg-white flex flex-col items-center justify-center sm:ml-0 ml-4 text-center shadow-3xl">
                        <img src={box7}/>
